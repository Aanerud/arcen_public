//! NVENC GUID constants generated from the vendored MIT-licensed nv-codec-headers header.
...
//!
//! Every constant here must be defined by that header. Two — the H.264 High 10
//! and High 4:2:2 profile GUIDs — were once present without being defined by it
//! and without being used by anything, which is precisely how SDK-derived
//! material survives a clean-room swap. `scripts/ci/check-publication-hygiene.sh`
//! now compares this file against the vendored header so that cannot recur.
